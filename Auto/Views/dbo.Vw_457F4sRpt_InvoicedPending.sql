...
SET QUOTED_IDENTIFIER ON
GO
Create View Vw_457F4sRpt_PrevInvoiced as select Distinct Vw_457F4sRpt_BOM.ChallanID,Sum(Vw_457F4sRpt_BOM.InvQty) as Sum_PrevSold from Vw_457F4sRpt_BOM where Vw_457F4sRpt_BOM.PtyID=423 and Vw_457F4sRpt_BOM.ItemID=1396 and Vw_457F4sRpt_BOM.InvDate< '08/01/2010' Group by Vw_457F4sRpt_BOM.ChallanID
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
Create View Vw_457F4sRpt_Invoiced as select V.ChallanID,V.ChallanNo,V.ChallanDate,V.ItemID,V.ChallanQty,V.ActualQty,V.InvId,V.InvNo,V.InvDate,V.InvQty,V.InvQty as TQty, PI.Sum_PrevSold from Vw_457F4sRpt_BOM V  Left Outer Join Vw_457F4sRpt_PrevInvoiced PI on V.ChallanID  = PI.ChallanID Where V.PtyID= 423 and V.ItemID=1396 and V.InvDate between '08/01/2010' and '08/24/2010' 
...
SET QUOTED_IDENTIFIER ON
GO
Create View Vw_457F4sRpt_InvoicedPending as select Distinct Vw_457F4sRpt_BOM.ChallanID,Vw_457F4sRpt_BOM.ChallanNo,Vw_457F4sRpt_BOM.ChallanDate,Vw_457F4sRpt_BOM.ChallanQty,Vw_457F4sRpt_BOM.ActualQty,Sum(Vw_457F4sRpt_BOM.InvQty) as Sum_PrevSold,Vw_457F4sRpt_Invoiced.ChallanID as ChID_Exists from Vw_457F4sRpt_BOM Left Outer Join Vw_457F4sRpt_Invoiced On Vw_457F4sRpt_BOM.ChallanID=Vw_457F4sRpt_Invoiced.ChallanID where Vw_457F4sRpt_BOM.PtyID = 423 and Vw_457F4sRpt_BOM.ItemID=1396 and Vw_457F4sRpt_BOM.ChallanDate <='08/24/2010' and Vw_457F4sRpt_BOM.InvDate<'08/01/2010' Group by Vw_457F4sRpt_BOM.ChallanID,Vw_457F4sRpt_Invoiced.ChallanID,Vw_457F4sRpt_BOM.ChallanNo,Vw_457F4sRpt_BOM.ChallanDate,Vw_457F4sRpt_BOM.ChallanQty,Vw_457F4sRpt_BOM.ActualQty
