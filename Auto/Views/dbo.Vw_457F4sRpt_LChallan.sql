...
GO
CREATE TABLE [dbo].[Trn_LOutChallanDetails](
	...
	[Rate] [money] NULL,
	[Rework] [float] NULL,
	[InChID] [numeric](18, 0) NULL,
	[InChNo] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[InChDate] [datetime] NULL,
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Trn_LOutChallan](
	[ChID] [numeric](18, 0) IDENTITY(1,1) NOT NULL,
	[ChNo] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[PtyID] [numeric](18, 0) NOT NULL,
	...
	[InChNo] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[InChDate] [datetime] NULL,
	[PrepTime] [varchar](15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[RemTime] [varchar](15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
SET QUOTED_IDENTIFIER ON
GO
Create View Vw_LOutChallanDetails as Select T.ChID,T.ChDate,T.ChNo,T.CoId,T.PtyID,C.InvType,M.AcName,D.InChID,D.ItemID,D.Qty,D.CRej as CR,D.MRej as MR,D.PORej as POR,D.Rework as RW,D.Returned as RET,D.TQty From Trn_LOutChallan T Inner Join Trn_CustOrder C on T.CoID=C.CoID Inner Join Mst_Party M on T.PtyID=M.PtyID Inner join Trn_LOutChallanDetails D ON T.ChID = D.ChID 
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
Create View Vw_457F4sRpt_LChallan as Select Distinct D.ChallanID,D.ChallanDate,D.PtyID,D.CoID,D.ChallanNo,D.ItemID,D.ActualQty,D.ChallanQty,L.ChId as InvID,L.ChNo as InvNo,L.ChDate as InvDate,L.Qty,L.CR,L.MR,L.POR,L.RW,L.RET,L.TQty,TC.PoNo from Vw_57F4Details D Left Outer Join Vw_LOutChallanDetails L on D.ChallanID=L.InChID and D.ItemID=L.ITemID Inner Join Trn_CustOrder TC on D.CoID=TC.CoID where TC.InvType = 'MChallan+Inv' or TC.InvType = 'Challan+Inv'
